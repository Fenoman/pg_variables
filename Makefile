...
REGRESS = pg_variables_upgrade pg_variables_oldapi pg_variables_advisory pg_variables pg_variables_any \
		...
		pg_variables_strict pg_variables_trans pg_variables_atx pg_variables_atx_pkg
