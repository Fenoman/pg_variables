...
REGRESS = pg_variables_upgrade pg_variables_oldapi pg_variables pg_variables_any \
		pg_variables_lifetime pg_variables_toast pg_variables_record_trans \
		pg_variables_phantom pg_variables_2pc pg_variables_bookkeeping \
		pg_variables_select_lifetime \
